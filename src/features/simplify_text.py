...
yle_data.to_csv("/home/chpatola/Desktop/Skola/Python/cookie_nlp/data/processed/processed_data.csv",
                index=False,
                encoding="ISO-8859-1"
                )
...
party_word_freq.to_csv('/home/chpatola/Desktop/Skola/Python/cookie_nlp/reports/party_word_freq.csv',
                       sep=',',
                       encoding="ISO-8859-1"
                       )
