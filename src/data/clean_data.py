...
yle_data = pd.read_csv(
    '/home/chpatola/Desktop/Skola/Python/cookie_nlp/data/raw/vastauksetavoimenadatana1.csv',
    sep=';',
    encoding="ISO-8859-1"
    )
...
yle_data_cut.to_csv(
    "/home/chpatola/Desktop/Skola/Python/cookie_nlp/data/interim/cleaned_data.csv",
